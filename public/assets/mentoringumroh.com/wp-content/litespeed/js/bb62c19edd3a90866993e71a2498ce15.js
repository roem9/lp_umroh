window._wpemojiSettings = {
  ...
  source: {
    concatemoji:
      "https://mentoringumroh.com/wp-includes/js/wp-emoji-release.min.js?ver=6.6.1",
  },
};
...
!(function (i, n) {
  ...
  "undefined" != typeof Promise &&
    ...
    (e = new Promise(function (e) {
      i.addEventListener("DOMContentLiteSpeedLoaded", e, { once: !0 });
    })),
...
(astraSmoothScroll = function (e, t) {
  ...
  (function () {
    ...
    if (
      ...
      window.addEventListener("DOMContentLiteSpeedLoaded", (e) => {
        for (var a of t)
                  ...
                  _: function () {
                    (H = n.now()),
                      ...
                      /d$|^c/.test(t.readyState)
                        ? ye()
                        : (c("load", ye),
                          t[s]("DOMContentLiteSpeedLoaded", re),
                          d(ye, 2e4)),
...
var fcaPcEvents = [
  {
    ...
    scroll: "0",
    apiAction: "track",
    ID: "8077e646-2573-434d-97ba-0440d4c42067",
    paused: !1,
  },
];
var fcaPcPost = {
  title: "Kelas Agent Gratis (Ads)",
  type: "page",
  id: "20",
  categories: [],
};
var fcaPcOptions = {
  pixel_types: ["Facebook Pixel"],
  ajax_url: "https://mentoringumroh.com/wp-admin/admin-ajax.php",
  debug: "",
  edd_currency: "USD",
  nonce: "be973fc46f",
  utm_support: "",
...
jQuery(document).ready(function (t) {
  function e(e, n, i) {
          ...
          fcaPcOptions.utm_support &&
            (t = (function (t) {
              for (
                ...
                null !== d(e[c]) && (t[e[c]] = d(e[c]));
              return t;
            })(t));
          fcaPcOptions.user_parameters &&
            (t = (function (t) {
              for (
                var e = [
                    "referrer",
                ...
                fcaPcUserParams[e[c]] && (t[e[c]] = fcaPcUserParams[e[c]]);
              return t;
            })(t));
          return t;
        })(i)
    ...
    if ("undefined" != typeof fbq) {
      var p = c(),
        s = a(),
        f = new Date(t.now()).toUTCString(),
        l = new Date(f).valueOf() / 1e3;
      if ("trackCustom" === e)
        fbq(e, n, r, { event_id: p, external_id: s }),
          o("Conversions API") &&
            t.ajax({
        ...
        u &&
          (fbq(e, u, r, { event_id: p, external_id: s }),
          o("Conversions API") &&
            t.ajax({
              url: fcaPcOptions.ajax_url,
              type: "POST",
    ...
    if ("undefined" != typeof snaptr) {
      ...
      if ("trackCustom" === e);
        ...
        _ && snaptr(e, _, r, { event_id: p, external_id: s });
      }
    }
    if ("undefined" != typeof ttq) {
      ...
      h && ttq.track(h, r), "trackCustom" === e && ttq.track(n, r);
    }
    ...
    if ("undefined" != typeof gtag) {
      ...
      "trackCustom" === e && gtag("event", n, r);
    }
  }
  function c() {
    return "xxxxxxxxxx".replace(/[x]/g, function (t) {
  ...
  function a() {
    var t = (function (t) {
      for (
        var e = t + "=", c = document.cookie.split(";"), a = 0;
        a < c.length;
        a++
      ) {
        for (var o = c[a]; " " == o.charAt(0); ) o = o.substring(1);
    ...
    return (
      "" == t &&
        ...
        (function (t, e, c) {
          var a = new Date();
          a.setTime(a.getTime() + 24 * c * 60 * 60 * 1e3);
  ...
  function d(t) {
    for (
      var e = [], c = location.search.substr(1).split("&"), a = 0;
      a < c.length;
      a++
    )
      if ((e = c[a].split("="))[0] === t)
  ...
  !(function () {
    for (var c = 0; c < fcaPcEvents.length; c++) {
      var a = fcaPcEvents[c].event,
        o = fcaPcEvents[c].parameters,
        n = fcaPcEvents[c].triggerType,
        i = fcaPcEvents[c].trigger,
        d = fcaPcEvents[c].apiAction;
      switch (n) {
        case "css":
          t(i).on("click", { name: a, params: o, apiAction: d }, function (t) {
            e(t.data.apiAction, t.data.name, t.data.params);
          });
          break;
        case "hover":
          t(i).on(
            "mouseenter",
            { name: a, params: o, apiAction: d, trigger: i },
            function (c) {
              e(c.data.apiAction, c.data.name, c.data.params),
                t(c.data.trigger).off("mouseenter");
            }
          );
          break;
        case "post":
          fcaPcEvents[c].hasOwnProperty("delay") &&
          fcaPcEvents[c].hasOwnProperty("scroll")
            ? setTimeout(
                function (c, a, o, n) {
                  t(window)
                    .scroll(
                        ...
                        c.data.scrollTarget <=
                          (function () {
                            var e = t(window).scrollTop(),
                              c = t(document).height() - t(window).height();
                            return 0 == c ? 100 : (e / c) * 100;
                          })() && (t(window).off(c), e(a, o, n));
                      }
                    )
                    .trigger("scroll");
                },
                1e3 * fcaPcEvents[c].delay,
                fcaPcEvents[c].scroll,
                d,
                a,
                o
              )
            : fcaPcEvents[c].hasOwnProperty("delay")
            ? setTimeout(e, 1e3 * fcaPcEvents[c].delay, d, a, o)
            : e(d, a, o);
          break;
        case "url":
          t("a").each(function () {
    ...
    (o("Facebook Pixel") || o("Conversions API")) && e("track", "PageView"),
    i("fca_pc_advanced_matching") && n("fca_pc_advanced_matching", ""),
    "undefined" != typeof fcaPcSearchQuery &&
      e("track", "Search", fcaPcSearchQuery),
    fcaPcOptions.woo_enabled &&
      (fcaPcOptions.debug && console.log("adding woo events"),
      t("body").on("added_to_cart", function () {
        t.ajax({
          ...
          success: function (t) {
            t.success &&
              ((o("Facebook") || o("Conversions API")) &&
                e("track", "AddToCart", t.facebook),
              o("TikTok") && e("track", "AddToCartTiktok", t.tiktok),
              o("Snapchat") && e("track", "AddToCartSnapchat", t.snapchat),
              o("Pinterest") && e("track", "AddToCartPinterest", t.pinterest),
              (o("GA3") || o("GA4") || o("Adwords")) &&
                e("track", "AddToCartGA", t.ga));
          },
        });
      }),
      i("fca_pc_woo_add_to_cart") &&
        (e(
          "track",
          "AddToCart",
          JSON.parse(
            decodeURIComponent(
              i("fca_pc_woo_add_to_cart").replace(/\+/g, "%20")
            )
          )
        ),
        n("fca_pc_woo_add_to_cart", "")),
      "undefined" != typeof fcaPcWooCheckoutCart &&
        (e("track", "InitiateCheckout", fcaPcWooCheckoutCart),
        t("form.checkout").on("checkout_place_order", function (t) {
          return e("track", "AddPaymentInfo", fcaPcWooCheckoutCart), !0;
        })),
      "undefined" != typeof fcaPcWooPurchase &&
        e("track", "Purchase", fcaPcWooPurchase),
      "undefined" != typeof fcaPcWooProduct &&
        (fcaPcOptions.woo_delay
          ? setTimeout(
              e,
              1e3 * fcaPcOptions.woo_delay,
              "track",
              "ViewContent",
              fcaPcWooProduct
            )
          : e("track", "ViewContent", fcaPcWooProduct),
        t(".wl-add-to, .add_to_wishlist").on("click", function (t) {
          e("track", "AddToWishlist", fcaPcWooProduct);
        })),
      i("fca_pc_woo_add_to_cart_tiktok") &&
        (e(
          "track",
          "AddToCartTiktok",
          JSON.parse(
            decodeURIComponent(
              i("fca_pc_woo_add_to_cart_tiktok").replace(/\+/g, "%20")
            )
          )
        ),
        n("fca_pc_woo_add_to_cart_tiktok", "")),
      "undefined" != typeof fcaPcWooCheckoutCartTiktok &&
        (e("track", "InitiateCheckoutTiktok", fcaPcWooCheckoutCartTiktok),
        t("form.checkout").on("checkout_place_order", function (t) {
          return (
            e("track", "AddPaymentInfoTiktok", fcaPcWooCheckoutCartTiktok), !0
          );
        })),
      "undefined" != typeof fcaPcWooPurchaseTiktok &&
        e("track", "PurchaseTiktok", fcaPcWooPurchaseTiktok),
      "undefined" != typeof fcaPcWooProductTiktok &&
        (fcaPcOptions.woo_delay
          ? setTimeout(
              e,
              1e3 * fcaPcOptions.woo_delay,
              "track",
              "ViewContentTiktok",
              fcaPcWooProductTiktok
            )
          : e("track", "ViewContentTiktok", fcaPcWooProductTiktok),
        t(".wl-add-to, .add_to_wishlist").on("click", function (t) {
          e("track", "AddToWishlistTiktok", fcaPcWooProductTiktok);
        })),
      i("fca_pc_woo_add_to_cart_pinterest") &&
        (e(
          "track",
          "AddToCartPinterest",
          JSON.parse(
            decodeURIComponent(
              i("fca_pc_woo_add_to_cart_pinterest").replace(/\+/g, "%20")
            )
          )
        ),
        n("fca_pc_woo_add_to_cart_pinterest", "")),
      "undefined" != typeof fcaPcWooPurchasePinterest &&
        e("track", "PurchasePinterest", fcaPcWooPurchasePinterest),
      "undefined" != typeof fcaPcWooProductPinterest &&
        (fcaPcOptions.woo_delay
          ? setTimeout(
              e,
              1e3 * fcaPcOptions.woo_delay,
      ...
      i("fca_pc_woo_add_to_cart_snapchat") &&
        (e(
          "track",
          "AddToCartSnapchat",
          JSON.parse(
            decodeURIComponent(
              i("fca_pc_woo_add_to_cart_snapchat").replace(/\+/g, "%20")
            )
          )
        ),
        n("fca_pc_woo_add_to_cart_snapchat", "")),
      "undefined" != typeof fcaPcWooCheckoutCartSnapchat &&
        (e("track", "InitiateCheckoutSnapchat", fcaPcWooCheckoutCartSnapchat),
        t("form.checkout").on("checkout_place_order", function (t) {
          return (
            e("track", "AddPaymentInfoSnapchat", fcaPcWooCheckoutCartSnapchat),
            !0
          );
        })),
      "undefined" != typeof fcaPcWooPurchaseSnapchat &&
        e("track", "PurchaseSnapchat", fcaPcWooPurchaseSnapchat),
      "undefined" != typeof fcaPcWooProductSnapchat &&
        (fcaPcOptions.woo_delay
          ? setTimeout(
              e,
              1e3 * fcaPcOptions.woo_delay,
              "track",
              "ViewContentSnapchat",
              fcaPcWooProductSnapchat
            )
          : e("track", "ViewContentSnapchat", fcaPcWooProductSnapchat),
        t(".wl-add-to, .add_to_wishlist").on("click", function (t) {
          e("track", "AddToWishlistSnapchat", fcaPcWooProductSnapchat);
        })),
      i("fca_pc_woo_add_to_cart_ga") &&
        (e(
          "track",
          "AddToCartGA",
          JSON.parse(
            decodeURIComponent(
              i("fca_pc_woo_add_to_cart_ga").replace(/\+/g, "%20")
            )
          )
        ),
        n("fca_pc_woo_add_to_cart_ga", "")),
      "undefined" != typeof fcaPcWooCheckoutCartGA &&
        (e("track", "InitiateCheckoutGA", fcaPcWooCheckoutCartGA),
        t("form.checkout").on("checkout_place_order", function (t) {
          return e("track", "AddPaymentInfoGA", fcaPcWooCheckoutCartGA), !0;
        })),
      "undefined" != typeof fcaPcWooPurchaseGA &&
        e("track", "PurchaseGA", fcaPcWooPurchaseGA),
      "undefined" != typeof fcaPcWooProductGA &&
        (fcaPcOptions.woo_delay
          ? setTimeout(
              e,
              1e3 * fcaPcOptions.woo_delay,
        ...
        t(".wl-add-to, .add_to_wishlist").on("click", function (t) {
          e("track", "AddToWishlistGA", fcaPcWooProductGA);
        }))),
    fcaPcOptions.edd_enabled &&
      (fcaPcOptions.debug && console.log("adding edd events"),
      t(".edd-add-to-cart").on("click", function (c) {
        if (o("Facebook") || o("Conversions API"))
          if ("undefined" != typeof fcaPcEddProduct)
            e("track", "AddToCart", fcaPcEddProduct);
          else {
            e(
              "track",
              "AddToCart",
              (a = {
                value: t(this).data("price"),
                currency: fcaPcOptions.edd_currency,
                content_name:
                  "Easy Digital Download ID " + t(this).data("download-id"),
                content_ids: t(this).data("download-id"),
                content_type:
                  "no" == t(this).data("variable-price")
                    ? "product"
                    : "product_group",
              })
            );
        ...
        if (o("TikTok"))
          if ("undefined" != typeof fcaPcEddProduct)
            e("track", "AddToCartTiktok", fcaPcEddProductTiktok);
          else {
            e(
              "track",
              "AddToCartTiktok",
        ...
        if (o("GA3") || o("GA4") || o("Adwords"))
          if ("undefined" != typeof fcaPcEddProductGA)
            e("track", "AddToCartGA", fcaPcEddProductGA);
          else {
            e(
              "track",
              "AddToCartGA",
              (a = {
                ...
                items: [
                  {
                    item_id: t(this).data("download-id"),
                    item_name:
                      "Easy Digital Download ID " + t(this).data("download-id"),
                  },
                ],
        ...
        if (o("Pinterest"))
          if ("undefined" != typeof fcaPcEddProductPinterest)
            e("track", "AddToCartPinterest", fcaPcEddProductPinterest);
          else {
            e(
              "track",
              "AddToCartPinterest",
              (a = {
                ...
                product_name:
                  "Easy Digital Download ID " + t(this).data("download-id"),
                product_id: t(this).data("download-id"),
              })
            );
          }
        if (o("Snapchat"))
          if ("undefined" != typeof fcaPcEddProductSnapchat)
            e("track", "AddToCartSnapchat", fcaPcEddProductSnapchat);
          else {
            var a = {
              ...
              description:
                "Easy Digital Download ID " + t(this).data("download-id"),
              item_ids: [t(this).data("download-id")],
            };
            e("track", "AddToCartSnapchat", a);
          }
      }),
      t(".wl-add-to, .add_to_wishlist").on("click", function (c) {
        if (o("Facebook") || o("Conversions API"))
          if ("undefined" != typeof fcaPcEddProduct)
            e("track", "AddToWishlist", fcaPcEddProduct);
          else {
            e(
              "track",
              "AddToWishlist",
        ...
        if (o("GA3") || o("GA4") || o("Adwords"))
          if ("undefined" != typeof fcaPcEddProductGA)
            e("track", "AddToWishlistGA", fcaPcEddProductGA);
          else {
            e(
              "track",
              "AddToWishlistGA",
        ...
        if (o("TikTok"))
          if ("undefined" != typeof fcaPcEddProductTiktok)
            e("track", "AddToWishlistTiktok", fcaPcEddProductTiktok);
          else {
            e(
              "track",
              "AddToWishlistTiktok",
        ...
        if (o("Snapchat"))
          if ("undefined" != typeof fcaPcEddProductSnapchat)
            e("track", "AddToWishlistSnapchat", fcaPcEddProductSnapchat);
          else {
            var a = {
              price: t(this).data("price"),
              currency: fcaPcOptions.edd_currency,
            ...
            e("track", "AddToWishlistSnapchat", a);
          }
      }),
      "undefined" != typeof fcaPcEddProduct &&
        (fcaPcPost.edd_delay
          ? setTimeout(
              e,
              1e3 * fcaPcPost.edd_delay,
              "track",
              "ViewContent",
              fcaPcEddProduct
            )
          : e("track", "ViewContent", fcaPcEddProduct)),
      "undefined" != typeof fcaPcEddCheckoutCart &&
        (e("track", "InitiateCheckout", fcaPcEddCheckoutCart),
        t("#edd_purchase_form").on("submit", function (t) {
          return e("track", "AddPaymentInfo", fcaPcEddCheckoutCart), !0;
        })),
      i("fca_pc_edd_purchase") &&
        (e(
          ...
          "Purchase",
          JSON.parse(
            decodeURIComponent(i("fca_pc_edd_purchase").replace(/\+/g, "%20"))
          )
        ),
        n("fca_pc_edd_purchase", "")),
      "undefined" != typeof fcaPcEddCheckoutCartGA &&
        (e("track", "InitiateCheckoutGA", fcaPcEddCheckoutCartGA),
        t("#edd_purchase_form").on("submit", function (t) {
          return e("track", "AddPaymentInfoGA", fcaPcEddCheckoutCartGA), !0;
        })),
      "undefined" != typeof fcaPcEddProductGA &&
        (fcaPcOptions.edd_delay
          ? setTimeout(
              e,
              1e3 * fcaPcOptions.edd_delay,
              "track",
              "ViewContent",
              fcaPcEddProductGA
            )
          : e("track", "ViewContentGA", fcaPcEddProductGA)),
      i("fca_pc_edd_purchase_ga") &&
        (e(
          "track",
          "PurchaseGA",
          JSON.parse(
            decodeURIComponent(
              i("fca_pc_edd_purchase_ga").replace(/\+/g, "%20")
            )
          )
        ),
        n("fca_pc_edd_purchase_ga", "")),
      "undefined" != typeof fcaPcEddProductTiktok &&
        (fcaPcPost.edd_delay
          ? setTimeout(
              e,
              1e3 * fcaPcPost.edd_delay,
              "track",
              "ViewContentTiktok",
              fcaPcEddProductTiktok
            )
          : e("track", "ViewContentTiktok", fcaPcEddProductTiktok)),
      "undefined" != typeof fcaPcEddCheckoutCartTiktok &&
        (e("track", "InitiateCheckoutTiktok", fcaPcEddCheckoutCartTiktok),
        t("#edd_purchase_form").on("submit", function (t) {
          return (
            e("track", "AddPaymentInfoTiktok", fcaPcEddCheckoutCartTiktok), !0
          );
        })),
      i("fca_pc_edd_purchase_tiktok") &&
        (e(
          ...
          JSON.parse(
            decodeURIComponent(
              i("fca_pc_edd_purchase_tiktok").replace(/\+/g, "%20")
            )
          )
        ),
      ...
      i("fca_pc_edd_purchase_ga") &&
        ...
        n("fca_pc_edd_purchase_ga", "")),
      "undefined" != typeof fcaPcEddProductPinterest &&
        (fcaPcOptions.edd_delay
          ? setTimeout(
              e,
              1e3 * fcaPcOptions.edd_delay,
              "track",
              "ViewContentPinterest",
              fcaPcEddProductPinterest
            )
          : e("track", "ViewContentPinterest", fcaPcEddProductPinterest)),
      i("fca_pc_edd_purchase_pinterest") &&
        (e(
          "track",
          "PurchasePinterest",
          JSON.parse(
            decodeURIComponent(
              i("fca_pc_edd_purchase_pinterest").replace(/\+/g, "%20")
            )
          )
        ),
        n("fca_pc_edd_purchase_pinterest", "")),
      "undefined" != typeof fcaPcEddCheckoutCartSnapchat &&
        (e("track", "InitiateCheckoutSnapchat", fcaPcEddCheckoutCartSnapchat),
        t("#edd_purchase_form").on("submit", function (t) {
          return (
            e("track", "AddPaymentInfoSnapchat", fcaPcEddCheckoutCartSnapchat),
            !0
          );
        })),
      "undefined" != typeof fcaPcEddProductSnapchat &&
        (fcaPcOptions.edd_delay
          ? setTimeout(
              e,
              1e3 * fcaPcOptions.edd_delay,
              "track",
              "ViewContentSnapchat",
              fcaPcEddProductSnapchat
            )
          : e("track", "ViewContentSnapchat", fcaPcEddProductSnapchat)),
      i("fca_pc_edd_purchase_snapchat") &&
        (e(
          "track",
          "PurchaseSnapchat",
          JSON.parse(
            decodeURIComponent(
              i("fca_pc_edd_purchase_snapchat").replace(/\+/g, "%20")
            )
          )
        ),
        n("fca_pc_edd_purchase_snapchat", ""))),
    "undefined" != typeof fcaPcVideos &&
      (fcaPcVideos.forEach(function (t) {
        t.on("pixel_event", function (t, c, a) {
          e(t, c, a);
        });
      }),
      fcaPcOptions.debug &&
        (console.log("fcaPcVideos:"), console.log(fcaPcVideos))),
    "undefined" != typeof fcaPcLandingPageCatEnabled &&
      t("#fca-lpc-optin-button").on("click", function (c) {
        var a;
        if (
          ((a =
            !(0 !== t("#fca-lpc-gdpr-consent").length) ||
            "checked" === t("#fca-lpc-gdpr-consent").attr("checked")),
          t("#fca-lpc-email-input").val())
        ) {
          t("#fca-lpc-email-input").val(), t("#fca-lpc-name-input").val();
          if (a)
            return e("track", "Lead", { content_name: fcaPcPost.title }), !0;
        }
      }),
    "undefined" != typeof fcaPcOptinCatEnabled &&
      t(".fca_eoi_form").submit(function (c) {
        var a = !0,
          o = t(this).find('input[name="name"]').val(),
          n = t(this).find('input[name="email"]').val();
        t(this).find('input[name="i_agree"]').length &&
          "checked" !== t(this).find(".fca_eoi_gdpr_consent").attr("checked") &&
          (a = !1),
          n &&
            a &&
            e("track", "Lead", {
              content_name: fcaPcPost.title,
              form_id: t(this).find("#fca_eoi_form_id").val(),
            });
      }),
    "undefined" != typeof fcaPcEptEnabled &&
      t(".ptp-checkout-button, .ptp-button, .fca-ept-button").on(
        "click",
        function (c) {
          (-1 !==
            t(this)
              .attr("href")
              .indexOf("?edd_action=add_to_cart&download_id") &&
            fcaPcOptions.edd_enabled) ||
            (-1 !== t(this).attr("href").indexOf("add-to-cart=") &&
              fcaPcOptions.woo_enabled) ||
            e("track", "InitiateCheckout", {
              content_name: fcaPcPost.title,
              pricing_table_id: (function (t) {
                var e = [];
                if (t.closest(".ptp-pricing-table").length)
                  e = t.closest(".ptp-pricing-table");
                else if (t.closest(".pricing_container").length)
                  e = t.closest(".pricing_container");
                else if (t.closest(".ptp-stylish-pricingtable").length)
                  e = t.closest(".ptp-stylish-pricingtable");
                else if (t.closest(".ptp-design4-pricingtable").length)
                  e = t.closest(".ptp-design4-pricingtable");
                else if (t.closest(".ptp-dg5-pricing-table").length)
                  e = t.closest(".ptp-dg5-pricing-table");
                else if (t.closest(".cd-pricing-container").length)
                  e = t.closest(".cd-pricing-container");
                else if (t.closest(".ptp-comparison1-pricingtable").length)
                  e = t.closest(".ptp-comparison1-pricingtable");
                else if (t.closest(".ptp-comparison2-pricingtable").length)
                  e = t.closest(".ptp-comparison2-pricingtable");
                else if (t.closest(".ptp-comparison3-pricingtable").length)
                  e = t.closest(".ptp-comparison3-pricingtable");
                else if (t.closest(".fca-ept-main").length)
                  return (e = t.closest(".fca-ept-main"))
                    .attr("id")
                    .replace("fca-ept-table-", "");
                return e.length ? e.attr("id").replace("ptp-", "") : "";
              })(t(this)),
              plan_name: (function (t) {
                var e = [];
                return (
                  t.closest(".ptp-col").find(".ptp-plan").length
                    ? (e = t.closest(".ptp-col").find(".ptp-plan"))
                    : t.closest(".pricing_item").find(".name").length
                    ? (e = t.closest(".pricing_item").find(".name"))
                    : t.closest(".ptp-stylish-column").find(".title").length
                    ? (e = t.closest(".ptp-stylish-column").find(".title"))
                    : t.closest(".ptp-design4-col").find(".ptp-design4-title")
                        .length
                    ? (e = t
                        .closest(".ptp-design4-col")
                        .find(".ptp-design4-title")
                        .eq(0))
                    : t.closest(".ptp-dg5-col").find(".ptp-dg5-plan").length
                    ? (e = t.closest(".ptp-dg5-col").find(".ptp-dg5-plan"))
                    : t
                        .closest(".ptp-dg6-col")
                        .find(".ptp-dg6-pricing-header h2").length
                    ? (e = t
                        .closest(".ptp-dg6-col")
                        .find(".ptp-dg6-pricing-header h2"))
                    : t
                        .closest(".ptp-dg7-col")
                        .find(".ptp-dg7-pricing-header h2").length
                    ? (e = t
                        .closest(".ptp-dg7-col")
                        .find(".ptp-dg7-pricing-header h2"))
                    : t.closest(".ptp-price-table").find(".ptp-plan-title h2")
                        .length
                    ? (e = t
                        .closest(".ptp-price-table")
                        .find(".ptp-plan-title h2"))
                    : t
                        .closest(".ptp-cp2-price-table")
                        .find(".ptp-cp2-plan-title h2").length
                    ? (e = t
                        .closest(".ptp-cp2-price-table")
                        .find(".ptp-cp2-plan-title h2"))
                    : t
                        .closest(".ptp-cp3-price-table")
                        .find(".ptp-cp3-plan-title h2").length
                    ? (e = t
                        .closest(".ptp-cp3-price-table")
                        .find(".ptp-cp3-plan-title h2"))
                    : t.closest(".fca-ept-column").find(".fca-ept-plan")
                        .length &&
                      (e = t.closest(".fca-ept-column").find(".fca-ept-plan")),
                  e.length ? e.text() : ""
                );
              })(t(this)),
              price: (function (t) {
                var e = [];
                return (
                  t.closest(".ptp-col").find(".ptp-price").length
                    ? (e = t.closest(".ptp-col").find(".ptp-price"))
                    : t.closest(".pricing_item").find(".price").length
                    ? (e = t.closest(".pricing_item").find(".price"))
                    : t.closest(".ptp-stylish-column").find(".price").length
                    ? (e = t.closest(".ptp-stylish-column").find(".price"))
                    : t.closest(".ptp-design4-col").find(".ptp-design4-price")
                        .length
                    ? (e = t
                        .closest(".ptp-design4-col")
                        .find(".ptp-design4-price"))
                    : t.closest(".ptp-dg5-col").find(".ptp-dg5-price").length
                    ? (e = t.closest(".ptp-dg5-col").find(".ptp-dg5-price"))
                    : t.closest(".ptp-dg6-col").find(".ptp-dg6-price").length
                    ? (e = t.closest(".ptp-dg6-col").find(".ptp-dg6-price"))
                    : t.closest(".ptp-dg7-col").find(".ptp-dg7-price").length
                    ? (e = t.closest(".ptp-dg7-col").find(".ptp-dg7-price"))
                    : t.closest(".ptp-price-table").find(".cp1-ptp-price")
                        .length
                    ? (e = t.closest(".ptp-price-table").find(".cp1-ptp-price"))
                    : t
                        .closest(".ptp-cp2-price-table")
                        .find(".ptp-cp2-row-id-0").length
                    ? (e = t
                        .closest(".ptp-cp2-price-table")
                        .find(".ptp-cp2-row-id-0"))
                    : t.closest(".ptp-cp3-price-table").find(".cp3-ptp-price")
                        .length
                    ? (e = t
                        .closest(".ptp-cp3-price-table")
                        .find(".cp3-ptp-price"))
                    : t.closest(".fca-ept-column").find(".fca-ept-price")
                        .length &&
                      (e = t.closest(".fca-ept-column").find(".fca-ept-price")),
                  e.length ? Number(e.text().replace(/[^0-9\.]+/g, "")) : ""
                );
              })(t(this)),
            });
        }
      ),
    "undefined" != typeof fcaPcQuizCatEnabled &&
      (t(".fca_qc_start_button").on("click", function (c) {
        return (
          e("trackCustom", "QuizStart", {
            quiz_id: parseInt(
              t(this)
                .closest(".fca_qc_quiz")
                .prop("id")
                .replace("fca_qc_quiz_", "")
            ),
            quiz_name: t(this)
              .closest(".fca_qc_quiz")
              .find(".fca_qc_quiz_title")
              .text(),
          }),
          !0
        );
      }),
      t(".fca_qc_share_link").on("click", function (c) {
        return (
          e("trackCustom", "QuizShare", {
            quiz_id: parseInt(
              t(this)
                .closest(".fca_qc_quiz")
                .prop("id")
      ...
      t(".fca_qc_submit_email_button").on("click", function (c) {
        var a;
        if (
          ((a =
            !(0 !== t(".fca-qc-gdpr-consent").length) ||
            "checked" === t(".fca-qc-gdpr-consent").attr("checked")),
          t(this).siblings("#fca_qc_email_input").val())
        ) {
          var o = parseInt(
              t(this)
                .closest(".fca_qc_quiz")
            ...
            n = t(this)
              ...
              .text();
          t(this).siblings("#fca_qc_email_input").val(),
            t(this).siblings("#fca_qc_name_input").val();
          if (a) return e("track", "Lead", { quiz_id: o, quiz_name: n }), !0;
        }
      }),
      t(".fca_qc_score_title").on("DOMSubtreeModified", function (c) {
        if (!t(this).data("pixelcat")) {
          t(this).data("pixelcat", !0);
          e("trackCustom", "QuizCompletion", {
            quiz_id: parseInt(
              t(this)
                .closest(".fca_qc_quiz")
                .prop("id")
  ...
  class FCA_PC_Video extends EventEmitter {
    ...
    api_vimeo_setup() {
      ...
      try {
        ...
        if (fcaPcOptions.debug) console.log(e.message);
        return;
      }
    }
    api_vimeo_ready() {
    ...
    api_wistia_setup() {
      ...
      const pattern =
        /(https:\/\/fast\.wistia\.com\/embed\/medias)\/(.*)\.jsonp/;
    ...
    api_wistia_ready(video) {
      ...
      this.title =
        video.data.media.name !== undefined
          ? video.data.media.name
          : "Untitled";
    ...
    percentage_watched() {
      switch (this.type) {
        case "YOUTUBE":
          return Math.round(
            (this.api.getCurrentTime() / this.api.getDuration()) * 100
          );
        case "VIMEO":
    ...
    trigger_event(action, additional_params = {}) {
      ...
      if (action !== "VideoPause") {
        this.events_triggered[action] = !0;
      }
    }
  }
...
var elementorFrontendConfig = {
  ...
  urls: {
    assets: "https://mentoringumroh.com/wp-content/plugins/elementor/assets/",
    ajaxurl: "https://mentoringumroh.com/wp-admin/admin-ajax.php",
  },
  nonces: { floatingButtonsClickTracking: "54bccd222c" },
  swiperClass: "swiper",
  ...
  post: {
    id: 20,
    title:
      "Kelas%20Agent%20Gratis%20%28Ads%29%20-%20Edukasi%20Umroh%20No.%201%20di%20Indonesia",
    excerpt: "",
    featuredImage:
      "https://mentoringumroh.com/wp-content/uploads/2023/12/Kelas-Gratis-Agent-1024x1024.jpg",
  },
}; /*! elementor - v3.23.0 - 05-08-2024 */
("use strict");
(self.webpackChunkelementor = self.webpackChunkelementor || []).push([
